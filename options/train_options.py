...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--lambda_vgg", type=float, default=0, help="perceptual loss weight"
        )
        parser.add_argument(
            "--no_cond_gan", action="store_true", help="do not use condition GAN"
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "--l2_weight", action="store_true", help="network l2 regularization"
        )
        ...
        parser.add_argument(
            "--debug", action="store_true", help="debug and use small training set"
        )
        ...
        parser.add_argument(
            ...
            type=int,
            default=10,
            help="Hyperband resource usage limit (default: 10)",
        )
        parser.add_argument(
            "--eta",
            type=float,
            default=3.0,
            help="Hyperband elimination rate (default: 3.0)",
        )
        parser.add_argument(
            "--max_jobs_tuner",
            type=int,
