...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # parser.add_argument('--loadSize', type=int, default=144, help='scale images to this size')
        ...
        #                     help='scaling and cropping of images at load time [resize_and_'
        #                          'crop|crop|scale_width|scale_width_and_crop]')
