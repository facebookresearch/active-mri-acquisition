...
for NAME in "symmetric_basic_rnl"; do
    CHECKPOINT_DIR=/checkpoint/${USER}/active_acq/all_reconstructors_raw_padding_fix/${NAME}_DICOM_2
    for policy in "random" "lowfirst" "evaluator_net"; do
        ...
        --evaluator_dir ${CHECKPOINT_DIR}_gamma_1000/evaluator \
        --checkpoints_dir ${CHECKPOINT_DIR}_gamma_1000/all_baselines.${BASELINES_SUFFIX} \
