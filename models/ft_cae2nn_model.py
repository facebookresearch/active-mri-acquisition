...
class FTCAE2NNModel(BaseModel):
    def name(self):
        return 'FTCAE2NNModel'
    ...
    def initialize(self, opt):
        ...
        self.netCVAE = init_net(CVAE(opt, in_channels=2, ctx_in_channels=4, out_channels=2), opt.init_type, self.gpu_ids) 
