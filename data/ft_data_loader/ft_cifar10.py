...
class FT_CIFAR10(data.Dataset):
    ...
    def __init__(self, root, unmask_ratio, normalize, train=True,
        ...
        print ('init kspace cifar dataset (unmasked_ratio: {:.2f}/{:.2f})'.format(unmask_ratio, low_freq_portion))
